...
func (x *SumReq) GetFirstNum() int32 {
	if x != nil {
		return x.FirstNum
	}
	return 0
...
func (x *SumReq) GetSecondNum() int32 {
	if x != nil {
		return x.SecondNum
	}
	return 0
...
type SumResp struct {
	...
	SumRest int32 `protobuf:"varint,1,opt,name=sum_rest,json=sumRest,proto3" json:"sum_rest,omitempty"`
}
...
func (x *SumResp) GetSumRest() int32 {
	if x != nil {
		return x.SumRest
	}
	return 0
...
var file_calculator_calculatorpb_calculator_proto_rawDesc = []byte{
	...
	0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x22, 0x44, 0x0a, 0x06, 0x53, 0x75, 0x6d, 0x52, 0x65, 0x71,
	...
	,
...
var file_calculator_calculatorpb_calculator_proto_goTypes = []interface{}{
	(*SumReq)(nil),  // 0: calculator.SumReq
	(*SumResp)(nil), // 1: calculator.SumResp
}
var file_calculator_calculatorpb_calculator_proto_depIdxs = []int32{
	0, // 0: calculator.CalculatorService.Sum:input_type -> calculator.SumReq
	1, // 1: calculator.CalculatorService.Sum:output_type -> calculator.SumResp
...
func (c *calculatorServiceClient) Sum(ctx context.Context, in *SumReq, opts ...grpc.CallOption) (*SumResp, error) {
	out := new(SumResp)
...
func (*UnimplementedCalculatorServiceServer) Sum(context.Context, *SumReq) (*SumResp, error) {
